...
export function ShellTerminal({
  ...
  useEffect(() => {
    ...
    const term = new Terminal({
      ...
      fontFamily: '"Fira Code Variable", ui-monospace, SFMono-Regular, Menlo, monospace', // straitjacket-allow:inline-font: xterm renders to a canvas and needs a literal font stack, not a CSS var
      lineHeight: 1.15,
